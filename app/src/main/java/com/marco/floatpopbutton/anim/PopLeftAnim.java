 ...
 * Time: 18:48
 */
public class PopLeftAnim implements IPosition {
    int measureHeight, normalHeight, padding, duration, alpha;
    private ArrayList<View> views = new ArrayList<>();

    public PopLeftAnim(int measureHeight, int normalHeight, int padding, ArrayList<View> views) {
        this(measureHeight, normalHeight, padding, 400, 1, views);
    }

    public PopLeftAnim(int measureHeight, int normalHeight, int padding, int duration, int alpha, ArrayList<View> views) {
